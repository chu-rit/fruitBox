...
$cssReset = "      html, body { height: 100%; margin: 0; padding: 0; background-color: #FFF8E7; }`n      body { overflow: hidden; padding-bottom: env(safe-area-inset-bottom); }`n      #root { display: flex; height: 100%; flex: 1; }"
