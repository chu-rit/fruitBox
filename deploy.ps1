...
$cssReset = "      html, body { margin: 0; padding: 0; background-color: #FFF8E7; }`n      body { position: fixed; inset: 0; overflow: auto; }`n      #root { display: flex; min-height: 100dvh; flex: 1; }"
